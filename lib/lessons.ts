...
export const LESSONS: Lesson[] = [
  {
    ...
    emoji: "🪐",
    concept: "Na nave, cada dado tem um tipo: texto, número, lógico ou lista.",
    goal: "Crie variáveis de texto e número, depois transmita os valores.",
    hint: 'Texto usa aspas: "Ana". Número não: 18. Lógico é verdadeiro ou falso.',
    exampleId: "tipos",
  },
  {
    id: "variaveis",
    ...
    title: "Variáveis",
    emoji: "🛸",
    concept: "Variável é a caixa de carga da nave — guarda um valor para usar depois.",
    goal: "Guarde dois números, some-os e mostre o resultado no HUD.",
  ...
  },
  {
    ...
    title: "Condição",
    emoji: "🧭",
    concept: "Se / Senão escolhe o caminho da missão como um piloto automático.",
    goal: "Pergunte a idade e mostre se o voo está autorizado.",
  ...
  },
  {
    ...
    title: "Repetição",
    emoji: "🔁",
    concept: "Loops repetem manobras: Para, Enquanto e Para cada item.",
    goal: "Use um loop Para e transmita os números de 1 até 5.",
  ...
  },
  {
    ...
    title: "Listas",
    emoji: "✨",
    concept: "Lista guarda vários itens numa única carga. O primeiro índice é 0.",
  ...
  },
  {
    ...
    title: "Funções",
    emoji: "🛠️",
    concept: "Funções são ferramentas prontas da estação espacial.",
